...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/vendor/boxicons/boxicons.min.css') ?>">
  ...
  <body>
    ...
    <section id="topbar" class="d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        ...
        <div class="social-links d-none d-md-flex align-items-center">
          ...
          <a href="#" class="instagram"><i class="fa fa-instagram" aria-hidden="true"></i></i></a>
    ...
    <header id="header" class="d-flex align-items-center">
      <div class="container d-flex align-items-center justify-content-between">
        <h1 class="logo">QuicFooD<span><img src="<?= base_url('assets/img/D1.png')  ?>" width="130" height="100"></span></h1>
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li class="dropdown"><a href="#"><span>User Services</span> <i class="fa fa-chevron-down"></i></a>
              <ul>
                <li><a class="nav-link scrollto" href="<?= base_url('/UserSignIn') ?>">User login</a></li>
                <li><?= anchor('/User_create', 'User Registration', 'class="nav-link scrollto"')  ?></li>
              </ul>
            </li>
            <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
          </ul>
          <i class="fab fa-list mobile-nav-toggle"></i>
        </nav><!-- .navbar -->
      </div>
    </header><!-- End Header -->
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="d-flex align-items-center">
      <div class="container" data-aos="zoom-out" data-aos-delay="100">
        <h1>Welcome to <span>QuicFooD</span></h1>
        <h2>We are team of talented designers making websites with Bootstrap</h2>
        <div class="d-flex">
          <a href="#about" class="btn-get-started scrollto">Get Started</a>
          <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="glightbox btn-watch-video"><i class="fa fa-play-circle"></i><span>Watch Video</span></a>
        </div>
      </div>
    </section><!-- End Hero -->
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="testimonial-item">
                  ...
                  <h4>Ceo &amp; Founder</h4>
                  <p>
                    <i class="fa fa-quote-alt-left quote-icon-left"></i>
                    Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper.
                    <i class="fa fa-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
